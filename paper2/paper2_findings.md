...
- **Phase 4b (running)**: g6k DSD-onset q-sweep at n=89 across fatigue
  (q∈{211,257,307,401,521}) — does SD-BKZ firing grow as q→fatigue+ on the
  sieve? Then the matched fplll β=40 q-sweep for the cross-engine map.
