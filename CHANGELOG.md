...
### Added
- **`[campaigns.ntru_b2_probe]`** — per-tour re-run (`store_per_tour = true`) of `ntru_b2` seeds showing the mid-trajectory dLN discontinuity, into its own seed tree so no `ntru_b2` seed is re-opened. Investigation note: `Research/postmortems/dln_discontinuity_2026-08-25_investigation.md`.
