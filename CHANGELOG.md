...
- **+2,451 seeds** from the two-node β=40/β=50 campaigns, all `status=completed`: `ntru` +1,988 (β=40 fill, n=109–179, q=503–7177 — canonical manifest 11,561 → 13,549), `ntru_b2` +240 (80 each at n=167/173/179), `ntru_b2_probe` +3, `ntru_g6k` +220 (G6K manifest 2,384 → 2,604). The G6K batch carries the β=50 frontier ladder at n=181 (dim 362, integer-exact recoveries as union of the two legs, SD-BKZ / BKZ in brackets): q=2593, 3083, 3407 all 0/20; q=3733 1/20 (1/0); q=4591 10/19 (7/4; seed 2 aborted on both attempts, INC-63); q=4871 12/20 (8/5); q=5381 8/19 (6/3); q=5869 6/16 (6/1); plus the n=179 q=4591 cell completed to 20/20 under the 86,400 s seed cap, 14/20 (11/6). Every short cell is short by g6k `gauss_sieve` assertion aborts (INC-63; seeds absent, not cap-killed) and is queued for rerun on the tolerant `sdbkz-g6k:dim384-inc63` image. Both manifests rebuilt; `lint-manifest` and `lint_g6k_manifest` report 0 violations.
